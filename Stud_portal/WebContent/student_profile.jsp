...
<TR>	
<TD> Name : <%=rs.getString(3)%></TD>
</TR>
<TR>
<TD>Email-ID : <%=rs.getString(4)%></TD>
</TR>

<TR>
<TD>Phone-NO : <%=rs.getString(5)%></TD>
</TR>
<TR>
<TD>Address :  <%=rs.getString(6)%></TD>
</TR>
<TR>
<TD>Course : <%=rs.getString(7)%></TD>
</TR>
<TR>
<TD>Department : <%=rs.getString(8)%></TD>
</TR>
<TR>
<TD>Semester : <%=rs.getString(9)%></TD>
</TR>
